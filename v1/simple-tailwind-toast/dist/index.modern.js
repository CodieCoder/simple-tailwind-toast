...
var toastContextStore = createContext(initialValues);
var toastContextDispatch = createContext(function () {
  return initialValues;
});
var useSimpleToast = function useSimpleToast() {
  var dispatch = useContext(toastContextDispatch);
  var toast = {
  ...
  return {
    store: useContext(toastContextStore),
    toast: toast
  };
};
...
var Toast = function Toast(_ref) {
  ...
  }, toast.content.title), React.createElement("div", {
    className: 'toast-description'
  }, toast.content.description)), React.createElement("div", {
    className: 'right'
...
var SimpleToastProvider = function SimpleToastProvider(_ref) {
  ...
  var _useReducer = useReducer(toastReducer, initialValues),
    state = _useReducer[0],
    dispatch = _useReducer[1];
  return React.createElement(toastContextStore.Provider, {
    value: state
  }, React.createElement(toastContextDispatch.Provider, {
    value: dispatch
  }, children));
};
